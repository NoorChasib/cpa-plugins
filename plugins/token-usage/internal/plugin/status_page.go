...
var sidebarDocument = "<!doctype html>\n<html lang=\"en\"><head><meta charset=\"utf-8\"><meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"><title>Token Usage</title><style>" + sidebarStyle + "</style></head><body>" + sidebarHTML + "<script>" + sidebarScript + "</script></body></html>"
