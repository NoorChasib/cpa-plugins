// Package clock abstracts time for the auto-baseline engine so that the
// periodic state save, promotion cooldown timers, and observation-window
// expiry can be tested deterministically with a fake clock.
package clock
