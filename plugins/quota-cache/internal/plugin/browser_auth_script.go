...
// exposes window.quotaCacheAuth with three helpers:
//
...
(function (global) {
	...
	function managementPath(suffix) {
		...
		var prefix = "";
		var markers = ["/v0/management/plugins/quota-cache", "/v0/resource/plugins/quota-cache"];
		...
		return prefix + "/v0/management/plugins/quota-cache" + suffix;
	}
