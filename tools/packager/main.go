...
// auto-baseline. It is invoked by the Makefile and the GitHub release
...
//
//	go run ./tools/packager -lib auto-baseline.so -version 0.1.0 -goos linux -goarch amd64 -out dist
//
